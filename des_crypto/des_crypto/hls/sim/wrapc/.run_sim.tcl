...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "des_encrypt.autotvin.dat"
	set constFileTvOut       "des_encrypt.autotvout.dat"
	set constFileHdlTvIn     "des_encrypt.autohdltvin.dat"
	set constFileHdlTvOut    "des_encrypt.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

...
if {[file isfile des_encrypt.autotvin.dat]} {
	file delete -force des_encrypt.autotvin.dat
}

if {[file isfile des_encrypt.autotvout.dat]} {
	file delete -force des_encrypt.autotvout.dat
}

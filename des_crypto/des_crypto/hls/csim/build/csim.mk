...
HLS_SOURCES = ../../../../../des_tb.cpp ../../../../../des.cpp
...
$(ObjDir)/des_tb.o: ../../../../../des_tb.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../des_tb.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/des_tb.d

$(ObjDir)/des.o: ../../../../../des.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../../des.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++17 ${CCFLAG} -c -MMD  -fhls-csim -fhlstoplevel=des_encrypt $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/des.d
